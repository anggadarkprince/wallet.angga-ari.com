    ...
    <article class="container mt-4">
        ...
        <ol>
            <li>
                ...
                <p>
                    {{ config('app.name') }}, hereafter referred to as {{ config('app.name') }}, undertakes to maintain
                    the client’s
                    content stored in the cloud available to third parties for 99.9% of the
                    quantified time, and the objective of {{ config('app.name') }}’s service will be to achieve 100%
                    access
                    availability.
                </p>
                <p>
                    {{ config('app.name') }} cannot guarantee 100% service availability due to Internet problems,
            ...
            <li>
                ...
                <ol>
                    ...
                    <li>Response time: Period of time in which the CLIENT receives a qualified statement from an
                    ...
                    <li>
                        Availability [%]: Total time minus time of inactivity divided by total time (Refer to Appendix
                        A).
                    </li>
                    <li>
        ...
        <h4 class="font-weight-bold">Starter Accounts</h4>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
            <tr>
                <td>Support schedule (CET time zone)</td>
        ...
        <h4 class="mt-5 font-weight-bold">Premium Accounts</h4>
        ...
        <p class="my-5">
            ...
            <a href="{{ route('contact') }}">our support</a> or learn more in
